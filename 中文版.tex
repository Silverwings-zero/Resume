...
\begin{tabularx}{\textwidth}{@{}p{\datecolwidth} X@{}}
    ...
    % TODO: 作者名单确定后请将 ``et al.'' 替换为完整作者列表。
    \textbf{在投} & \textbf{Wanli Qian} et al. ``TouchTwin: Human-in-the-Loop Haptic Texturing of 3D-Scanned Tabletop Scenes with Vision--Language Recognition and Language-Guided Generation.'' \textit{Proc. ACM CHI Conference on Human Factors in Computing Systems (CHI)}, 2027.（审稿中） \\[6pt]

    & \textbf{Wanli Qian} et al. ``Feeling What the Gripper Feels: Haptic Rendering of a Grasped Object from Tactile Video in Teleoperation.'' \textit{IEEE Robotics and Automation Letters (RA-L)}, 2027.（审稿中） \\[6pt]
...
\noindent
\begin{tabularx}{\textwidth}{@{}p{\datecolwidth} X@{}}
    \textbf{指导} & \textbf{\href{https://viterbiundergrad.usc.edu/research/curve/}{USC CURVE Program Mentor}}（2025春、2025秋、2026春、2026秋） \\
    & 指导本科生参与科研。 \\[4pt]
    
    & \textbf{\href{https://viterbischool.usc.edu/sure/}{USC Viterbi SURE Program Mentor}}（2025夏） \\
    & 本科生暑期科研项目导师。 \\[4pt]

    & \textbf{USC REU Program Mentor}（2026夏） \\
    & 本科生科研体验项目导师。 \\[6pt]
